...
1. [Motion and Distortion Correction](../Data_Processing/MotionCorrection.md "Beauchamp:MotionCorrection")
2. [Autism Data](../Data_Processing/Autism.md "Beauchamp:Autism")
3. [Group analysis with Matlab ANOVAN](../Data_Processing/anovan.md)
...
*NOTE: See [Beauchamp:FreeSurfer](../Data_Processing/FreeSurfer.md) about converting a surface file to a .asc file*
