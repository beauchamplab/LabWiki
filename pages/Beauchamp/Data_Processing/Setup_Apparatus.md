...
5. Set up display cart and [eye tracker](../Data_Processing/Eye_Tracker.md).  
6. Run [Experimental Protocol](../Data_Processing/Electrophysiology.md "Beauchamp:Electrophysiology")  
7. [Shut Down](../Data_Processing/Shut_Down_Apparatus.md).
