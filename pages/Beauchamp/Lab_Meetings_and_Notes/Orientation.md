...
3. Visit [Beauchamp:Software\_Installation#Connecting\_to\_the\_Lab\_Mac\_Server](../Data_Processing/Software_Installation.md#Connecting_to_the_Lab_Mac_Server "Beauchamp:Software Installation") to connect to the lab server.
...
9. Visit <http://library.tmc.edu> to learn about all of the journals and databases we have access too. Use your BCM ID/password to login.
