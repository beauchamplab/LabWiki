...
Before analyzing the retinotopy data, motion correct by aligning all EPIs to the mean EPI and registering that to the high-res anatomy, both in a single step to reduce noise. For more info, see [Motion and Distortion Correction](MotionCorrection.md "Beauchamp:MotionCorrection")
