...
|  |  |
| --- | --- |
| [RAVE logo](../../attachments/ravebuiltins:toolbar/RAVE_Logo_new.jpg "RAVE logo") | **R**eproducible **A**nalysis and **V**isualization of i**E**EG   ***RAVE*** |
...
The RAVE toolbar contains input panels on the left ("Configure Analysis") and output panels on the right ("Results on Surface").
[![RAVE toolbar and panels](../../attachments/ravebuiltins:toolbar/RaveGUIToolbar_overview.png)](../../attachments/ravebuiltins:toolbar/RaveGUIToolbar_overview.png "RAVE toolbar and panels")
